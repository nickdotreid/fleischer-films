...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for film in orm.Film.objects.exclude(copyright_status=None).all():
            cp, created = orm.CopyrightStatus.objects.get_or_create(name=film.copyright_status)
            film.copyright_status_fk = cp
            film.save()
