...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'films_film', 'copyright_status_id')
    ...
    models = {
        ...
        u'films.film': {
            ...
            'copyright_status_fk': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'foo'", 'null': 'True', 'to': u"orm['films.CopyrightStatus']"}),
