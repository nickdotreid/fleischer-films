...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilmLocation.source_type'
        db.add_column(u'films_filmlocation', 'source_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.LocationType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilmLocation.source_type'
        db.delete_column(u'films_filmlocation', 'source_type_id')
