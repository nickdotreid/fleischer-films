...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CopyrightStatus.name'
        db.alter_column(u'films_copyrightstatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'CopyrightStatus.name'
        db.alter_column(u'films_copyrightstatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
