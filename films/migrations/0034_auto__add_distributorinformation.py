...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DistributorInformation'
        db.create_table(u'films_distributorinformation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.Film'])),
            ('distributor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.Distributor'])),
            ('start_year', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('end_year', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('original', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'films', ['DistributorInformation'])


    def backwards(self, orm):
        # Deleting model 'DistributorInformation'
        db.delete_table(u'films_distributorinformation')
