...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Crew'
        db.create_table(u'films_crew', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.Film'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.Person'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.Role'])),
        ))
        db.send_create_signal(u'films', ['Crew'])

        # Adding model 'Person'
        db.create_table(u'films_person', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('notes', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'films', ['Person'])

        # Adding model 'Role'
        db.create_table(u'films_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'films', ['Role'])


    def backwards(self, orm):
        # Deleting model 'Crew'
        db.delete_table(u'films_crew')

        # Deleting model 'Person'
        db.delete_table(u'films_person')

        # Deleting model 'Role'
        db.delete_table(u'films_role')
