...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'films_person', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Person.notes'
        raise RuntimeError("Cannot reverse this migration. 'Person.notes' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Person.notes'
        db.alter_column(u'films_person', 'notes', self.gf('django.db.models.fields.TextField')())
