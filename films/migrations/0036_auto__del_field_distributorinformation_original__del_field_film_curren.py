...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DistributorInformation.original'
        db.delete_column(u'films_distributorinformation', 'original')
    ...
    def backwards(self, orm):
        # Adding field 'DistributorInformation.original'
        db.add_column(u'films_distributorinformation', 'original',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Film.current_distributor'
        db.add_column(u'films_film', 'current_distributor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='current_films', null=True, to=orm['films.Distributor'], blank=True),
                      keep_default=False)
