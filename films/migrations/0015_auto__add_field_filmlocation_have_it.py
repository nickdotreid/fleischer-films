...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilmLocation.have_it'
        db.add_column(u'films_filmlocation', 'have_it',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilmLocation.have_it'
        db.delete_column(u'films_filmlocation', 'have_it')
