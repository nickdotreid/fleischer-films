...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FilmLocation.location'
        db.delete_column(u'films_filmlocation', 'location')


    def backwards(self, orm):
        # Adding field 'FilmLocation.location'
        db.add_column(u'films_filmlocation', 'location',
