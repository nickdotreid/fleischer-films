...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Film.work_notes'
        db.alter_column(u'films_film', 'work_notes', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

    def backwards(self, orm):

        # Changing field 'Film.work_notes'
        db.alter_column(u'films_film', 'work_notes', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
