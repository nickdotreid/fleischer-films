...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CopyrightStatus'
        db.create_table(u'films_copyrightstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'films', ['CopyrightStatus'])

        # Adding field 'Film.copyright_status_fk'
        db.add_column(u'films_film', 'copyright_status_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['films.CopyrightStatus'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Film.copyright_claimant'
        db.alter_column(u'films_film', 'copyright_claimant', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting model 'CopyrightStatus'
        db.delete_table(u'films_copyrightstatus')

        # Deleting field 'Film.copyright_status_fk'
        db.delete_column(u'films_film', 'copyright_status_fk_id')


        # Changing field 'Film.copyright_claimant'
        db.alter_column(u'films_film', 'copyright_claimant', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
